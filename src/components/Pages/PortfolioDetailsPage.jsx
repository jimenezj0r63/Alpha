...
export default function PortfolioDetailsPage() {
  ...
  return (
    <>
      ...
      <Div className="container">
        ...
        <Div className="row">
          ...
          <Div className="col-lg-5 offset-lg-1">
            ...
            <Div className="row">
              <Div className="col-6">
                <h3 className='cs-accent_color cs-font_22 cs-font_18_sm cs-m0'>Categoria:</h3>
                <p className='cs-m0'>Artwork</p>
                <Spacing lg='30' md='30'/>
              </Div>
              <Div className="col-6">
                <h3 className='cs-accent_color cs-font_22 cs-font_18_sm cs-m0'>Hubicacion:</h3>
                <p className='cs-m0'>Santa Maria Xadani</p>
                <Spacing lg='30' md='30'/>
              </Div>
              <Div className="col-6">
              ...
              <Div className="col-6">
                ...
                <p className='cs-m0'>Jorge Jimenez</p>
                <Spacing lg='30' md='30'/>
              </Div>
            </Div>
          </Div>
      ...
      <Cta 
        title='contacto@alphatechagencia.com' 
